...
function Page() {
  ...
  return (
    <main className="mx-auto max-w-6xl px-5 py-16">
      <p className="text-xs uppercase tracking-[0.2em] text-[#c4a46a]">{t({ es: 'Universidad', en: 'University' })}</p>
      ...
      <div className="mt-12 space-y-8">
        {teaching.posts.map((p) => (
          <article key={p.school} className="grid gap-6 overflow-hidden rounded-2xl border border-[#0b1f38]/10 bg-white md:grid-cols-[1.2fr_0.8fr]">
